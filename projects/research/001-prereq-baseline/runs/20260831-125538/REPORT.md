# 001-prereq-baseline — run 20260831-125538
...
| `plan` | `flow` | {'order': 'prereq', 'passes': 1, 'review_mode': 'cyclic', 'feedback': False, ... |
...
Prediction FAILED: mean_mastery_pct=11.98, predicted >= 80.0. Claim: Prerequisite-ordered single-pass tutoring reaches >=80% mean mastery Refutation condition: mean_mastery_pct < 80.0 Run started by hand: 001-prereq-baseline/20260831-125538.
...
_Generated from `trace.json` for run 20260831-125538. Every number above came from the recorded execution._
